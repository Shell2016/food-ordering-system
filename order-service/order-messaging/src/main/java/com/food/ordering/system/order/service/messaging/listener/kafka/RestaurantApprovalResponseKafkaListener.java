    ...
    public void receive(@Payload List<RestaurantApprovalResponseAvroModel> messages,
        ...
        messages.forEach(avroModel -> {
            if (OrderApprovalStatus.APPROVED == avroModel.getOrderApprovalStatus()) {
                log.info("Processing approved order for order id: {}", avroModel.getOrderId());
                listener.orderApproved(mapper.restaurantApprovalResponseAvroModelToRestaurantApprovalResponse(avroModel));
                ...
                listener.orderRejected(mapper.restaurantApprovalResponseAvroModelToRestaurantApprovalResponse(avroModel));
            }
        });
    }
}
